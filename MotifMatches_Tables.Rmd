...
#MotifHits_raw<- MotifHits_raw %>% select(-...23)
```
...
# slimOverlapMatrix(CytSkl_b_names,CytSkl_b)
# slimOverlapArray(CytSkl_b_names,CytSkl_b)
# slimOverlapTriples(slimOverlapArray(CytSkl_a_names,CytSkl_a))
# 
# slimOverlapArray(c(CytSkl_a_names,CytSkl_b_names),rbind(CytSkl_a,CytSkl_b))
# slimOverlapTriples(slimOverlapArray(c(CytSkl_a_names,CytSkl_b_names),rbind(CytSkl_a,CytSkl_b)))
...
# RGD %>% filter(TM_Domains>1) %>% select(Motif_Name) %>% table()
# RGD %>% filter(TM_Domains>1)  %>% select(Predicted_Location_TAGM_MAP) %>% table()
# RGD %>% filter(TM_Domains>1 & Organelle=="micronemes") 
# RGD %>% filter(Organelle=="micronemes") %>% select(seq_id, Product_Description, Motif_Name, Motif_Instance,Motif_sSite, Dis_context, presence_str, presence_spc, Motif_acc,TM_Domains)
# RGD %>% filter(Organelle=="micronemes") %>% select(Motif_Name) %>% table()
# MotifHits %>% filter(seq_id=="TGME49_214940")
...
#NLS %>% filter(Organelle=="dense_granules") 
#NLS %>% filter(Organelle=="dense_granules")  %>% select(seq_id, Product_Description) %>% unique()
#TGME49_240060
#NLS %>% filter(Organelle=="rhoptries") 
#NLS %>% filter(Organelle=="rhoptries")  %>% select(seq_id, Product_Description) %>% unique()
...
# PDZ %>% filter(Organelle=="dense_granules") 
# PDZ %>% filter(Organelle=="dense_granules")  %>% select(seq_id, Product_Description) %>% unique()
# PDZ %>% filter(Organelle=="rhoptries") 
# PDZ %>% filter(Organelle=="rhoptries")  %>% select(seq_id, Product_Description) %>% unique()

# ggplot(PDZ, aes(y=presence_spc, x=Organelle)) + geom_point()+
#   ggtitle("PDZ motifs matches accross organelles") +  xlab("Organelle") + ylab("Presence proportion") +
#   theme_classic() + theme(axis.text.x = element_text(angle = -45, vjust = 0.5, hjust=0.1)) +
#   theme(axis.text=element_text(size=8),axis.title=element_text(size=12,face="bold"))
# 
# ggplot(PDZ, aes(y=presence_spc, x=Predicted_Location_TAGM_MAP)) + geom_point()+
#   ggtitle("PDZ motifs matches accross organelles") +  xlab("Predicted Location TAGM MAP") + ylab("Presence proportion") +
#   theme_classic() + theme(axis.text.x = element_text(angle = -45, vjust = 0.5, hjust=0.1)) +
#   theme(axis.text=element_text(size=8),axis.title=element_text(size=12,face="bold"))
...
# MotifHits_filt %>% filter(Motif_Name=="DEG_APCC_KENBOX_2",Organelle=="dense_granules") 
# MotifHits_filt %>% filter(Motif_Name=="DEG_APCC_KENBOX_2",Organelle=="dense_granules")  %>% select(seq_id, Product_Description) %>% unique()
# MotifHits_filt %>% filter(Motif_Name=="DEG_APCC_KENBOX_2",Organelle=="rhoptries") 
# MotifHits_filt %>% filter(Motif_Name=="DEG_APCC_KENBOX_2",Organelle=="rhoptries")  %>% select(seq_id, Product_Description) %>% unique()
```

```{r Calcineurin,echo = FALSE}
Calc_names <- c("DOC_PP2B_PxIxI_1" ,"LIG_LRP6_Inhibitor_1")
kable(r_d_tibble(Calc_names,MotifHits_filt))
#kable(r_d_tables("DOC_PP2B_PxIxI_1"))
# MotifHits_filt %>% filter(Motif_Name=="DOC_PP2B_PxIxI_1",Organelle=="dense_granules") 
# MotifHits_filt %>% filter(Motif_Name=="DOC_PP2B_PxIxI_1",Organelle=="dense_granules")  %>% select(seq_id, Product_Description) %>% unique()
# MotifHits_filt %>% filter(Motif_Name=="DOC_PP2B_PxIxI_1",Organelle=="rhoptries") 
# MotifHits_filt %>% filter(Motif_Name=="DOC_PP2B_PxIxI_1",Organelle=="rhoptries")  %>% select(seq_id, Product_Description) %>% unique()


Calcineurin<-read_tsv(file="/Users/JAVlvrd/Documents/Toxoplasma-2022/ToxoMotifs/Results/Calcineurin/Calcineurin_MotifMatches_complete.txt", col_names = T)
...
# ESCRT %>% filter(Organelle=="dense_granules") 
# ESCRT %>% filter(Organelle=="dense_granules")  %>% select(seq_id, Product_Description) %>% unique()
# ESCRT %>% filter(Organelle=="rhoptries") 
# ESCRT %>% filter(Organelle=="rhoptries")  %>% select(seq_id, Product_Description) %>% unique()
...
# Proteasome %>% filter(Organelle=="dense_granules") 
# Proteasome %>% filter(Organelle=="dense_granules")  %>% select(seq_id, Product_Description) %>% unique()
# Proteasome %>% filter(Organelle=="rhoptries") 
# Proteasome %>% filter(Organelle=="rhoptries")  %>% select(seq_id, Product_Description) %>% unique()
...
# CytSkl_a %>% filter(Organelle=="dense_granules") 
# CytSkl_a %>% filter(Organelle=="dense_granules")  %>% select(seq_id, Product_Description) %>% unique()
# CytSkl_a %>% filter(Organelle=="rhoptries") 
# CytSkl_a %>% filter(Organelle=="rhoptries")  %>% select(seq_id, Product_Description) %>% unique()
...
#slim2overlap("LIG_ActinCP_TwfCPI_2","LIG_IBAR_NPY_1",CytSkl_a) #1 TGME49_262920
...
# CytSkl_b %>% filter(Organelle=="dense_granules") 
# CytSkl_b %>% filter(Organelle=="dense_granules")  %>% select(seq_id, Product_Description) %>% unique()
# CytSkl_b %>% filter(Organelle=="rhoptries") 
# CytSkl_b %>% filter(Organelle=="rhoptries")  %>% select(seq_id, Product_Description) %>% unique()

slimsVennOverlap("LIG_SxIP_EBH_1","DOC_PP2A_B56_1" ,"LIG_KLC1_WD_1",CytSkl_b,"CytSkl_b_sec.png")
# slimsVennOverlap("LIG_SxIP_EBH_1","DOC_PP2A_B56_1" ,"LIG_KLC1_WD_1",CytSkl_b,"CytSkl_b_rhop.png")
# slimsVennOverlap("LIG_SxIP_EBH_1","DOC_PP2A_B56_1" ,"LIG_KLC1_WD_1",CytSkl_b,"CytSkl_b_degr.png")
```
...
# temp_d <-tibble()
# for(i in 1:length(CytSkl_over_1)){
#   for(j in 1:length(CytSkl_over_2)){
#     matches<-slim2overlap(CytSkl_over_1[i],CytSkl_over_2[j],CytSkl) 
#     if(length(matches)>0){
#       for(m in 1:length(matches)){
#         temp <- CytSkl %>% filter(seq_id==matches[m]) %>% select(seq_id,Product_Description, Organelle) %>% unique()
#         temp_d <-rbind(temp_d,temp)
#       }
#     }
#   }
# }
...
# NFkB %>% filter(Organelle=="dense_granules") 
# NFkB %>% filter(Organelle=="dense_granules")  %>% select(seq_id, Product_Description) %>% unique()
# NFkB %>% filter(Organelle=="rhoptries") 
# NFkB %>% filter(Organelle=="rhoptries")  %>% select(seq_id, Product_Description) %>% unique()

# MotifHits_filt %>% filter(Motif_Name=="LIG_TRAF6",Organelle=="dense_granules") 
# MotifHits_filt %>% filter(Motif_Name=="LIG_TRAF6",Organelle=="dense_granules")  %>% select(seq_id, Product_Description) %>% unique()
# MotifHits_filt %>% filter(Motif_Name=="LIG_TRAF6",Organelle=="rhoptries") 
# MotifHits_filt %>% filter(Motif_Name=="LIG_TRAF6",Organelle=="rhoptries")  %>% select(seq_id, Product_Description) %>% unique()
